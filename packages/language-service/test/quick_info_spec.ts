...
describe('quick info', () => {
  ...
  describe('strict templates (happy path)', () => {
    ...
    describe('let declarations', () => {
      ...
      it('multiple let declarations in a single statement', () => {
        expectQuickInfo({
          templateOverride: `@let one = 1, tw¦o = one + 1, three = two + 1;`,
          expectedSpanText: `two = one + 1`,
          expectedDisplayString: `(let) two: number`,
        });
      });
    });
