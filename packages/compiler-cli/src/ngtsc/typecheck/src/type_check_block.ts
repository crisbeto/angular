...
import {TemplateId, TypeCheckableComponentMeta, TypeCheckableDirectiveMeta, TypeCheckBlockMetadata} from '../api';
...
class TcbElementOp extends TcbOp {
  ...
  override execute(): ts.Identifier {
    ...
    this.checkForInvalidContentProjection();
    return id;
  }

  private checkForInvalidContentProjection(): void {}
}
...
export class Context {
  ...
  constructor(
      ...
      readonly boundTarget: BoundTarget<TypeCheckableDirectiveMeta, TypeCheckableComponentMeta>,
