...
suppress
    ...
    describe('@let declarations', () => {
      ...
      it('should not allow a let declaration to be referenced before it is defined in the same statement', () => {
        env.write(
          'test.ts',
          `
          import {Component} from '@angular/core';
        ...
        expect(diags.length).toBe(1);
        expect(diags[0].messageText).toBe(
          `Cannot read @let declaration 'after' before it has been defined.`,
        );
      });
