...
describe('standalone migration', () => {
  ...
  it('should a remove a module that only has imports and exports', async () => {
  ...
  it('should a remove a chain of modules that all depend on each other', async () => {
  ...
  it('should not remove the module file if it contains other code', async () => {
    writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
  ...
  it('should a remove module references from export expressions', async () => {
    writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
