...
import {AfterViewChecked, AfterViewInit, Component, Directive, EventEmitter, forwardRef, inject, Inject, InjectionToken, Input, OnChanges, OnInit, Output, SimpleChanges, Type, ViewChild, ViewContainerRef} from '@angular/core';
...
describe('host directives', () => {
  ...
  describe('dependency injection', () => {
    ...
    it('should be able to inject a host directive into a child component', () => {
      ...
      @Component({selector: 'host', template: '<child></child>', hostDirectives: [HostDir]})
      class Host {
    ...
    describe('host bindings', () => {
      ...
      it('should have the host bindings of the root component take precedence over the ones from the host directives',
         () => {
           ...
           @Component({template: '', host: {'id': 'host'}, hostDirectives: [HostDir, OtherHostDir]})
           class HostComp {
           }
