...
describe('hot module replacement', () => {
  ...
  it('should carry over tdependencies defined by setComponentScope', () => {
    // In some cases the AoT compiler produces a `setComponentScope` for non-standalone
    // components. We simulate it here by declaring two components that are not stalone and
    // manually calling `setComponentScope`.
