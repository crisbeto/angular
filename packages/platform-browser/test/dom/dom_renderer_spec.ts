...
@Component({
  selector: 'some-app',
  template: `
    @if (!componentOneInstanceHidden && showEmulatedComponents) {<cmp-emulated></cmp-emulated>}
    @if (!componentTwoInstanceHidden && showEmulatedComponents) {<cmp-emulated></cmp-emulated>}

    @if (!componentOneInstanceHidden && !showEmulatedComponents) {<cmp-none></cmp-none>}
    @if (!componentTwoInstanceHidden && !showEmulatedComponents) {<cmp-none></cmp-none>}
  `,
})
