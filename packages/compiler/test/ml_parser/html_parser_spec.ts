...
describe('HtmlParser', () => {
  ...
  describe('parse', () => {
    ...
    describe('let declaration', () => {
      ...
      it('should parse multiple let declarations in a single statement', () => {
        expect(humanizeDom(parseLet('@let one = 1, two = 2,\n three = one + two;'))).toEqual([
          [html.LetDeclaration, 'one', '1'],
          [html.LetDeclaration, 'two', '2'],
          [html.LetDeclaration, 'three', 'one + two'],
        ]);
      });
      ...
      it('should store the source location of a single @let declaration', () => {
      ...
      it('should store the source locations of multiple @let declarations', () => {
        const source = '@let one = 1, two = 2,\n three = one + two;';

        expect(humanizeDomSourceSpans(parseLet(source))).toEqual([
          [html.LetDeclaration, 'one', '1', '@let one = 1', 'one', '1'],
          [html.LetDeclaration, 'two', '2', 'two = 2', 'two', '2'],
          [html.LetDeclaration, 'three', 'one + two', 'three = one + two', 'three', 'one + two'],
        ]);
      });
